...
public class TestDOMParsing {
	...
	public static void main(String[] args) {
		try {
			 ...
			 TestDOMParsing [filename]"); System.exit(1);
			...
			System.out
					.println("The underlying parser does not support the requested features.");
		} catch (FactoryConfigurationError e) {
			System.out
					.println("Error occurred obtaining Document Builder Factory.");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
